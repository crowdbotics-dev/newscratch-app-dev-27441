...
## Project Structure
    ...
    ├── newscratch_app_dev_27441  # Django project configurations
...
1. Clone this repo and `cd newscratch_app_dev_27441`
...
2. Clone this repo and `cd newscratch_app_dev_27441`
